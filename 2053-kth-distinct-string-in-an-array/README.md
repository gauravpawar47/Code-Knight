<h2><a href="https://leetcode.com/problems/kth-distinct-string-in-an-array/?envType=problem-list-v2&envId=hash-table">2053. Kth Distinct String in an Array</a></h2><h3>Easy</h3><hr><p>A <strong>distinct string</strong> is a string that is present only <strong>once</strong> in an array.</p>
