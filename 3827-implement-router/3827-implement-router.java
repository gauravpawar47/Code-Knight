class Router 
{
    ...
    public long encode(final int source, final int destination, final int timestamp) 
    {
        return ((long)source << 40) | ((long)destination << 20) | timestamp;
    }

    public int lowerBound(final List<Integer> list, final int target) 
    {
        int low = 0;
        int high = list.size();
    ...
    public int upperBound(final List<Integer> list, final int target) 
    {
        int low = 0;
        int high = list.size();
