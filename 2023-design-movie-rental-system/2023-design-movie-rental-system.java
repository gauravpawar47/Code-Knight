class MovieRentingSystem 
{
    ...
    public static final Comparator<Node> CMP =
        (a, b) -> {
    ...
    public final Map<Integer, TreeSet<Node>> availableByMovie = new HashMap<>();
    // All currently rented copies
    public final TreeSet<Node> rentedSet = new TreeSet<>(CMP);
    // Quick lookup from (shop, movie) -> Node
    public final Map<Long, Node> byPair = new HashMap<>();

    public static long key(int shop, int movie) 
    {
